@ModelType TypeChampsViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.EditTypeChamps
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeChamps")>@Resource.ManageTypeSuivi</a></li>
        <li class="breadcrumb-item active">@Resource.EditTypeChamps</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeChamps</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeChamps", FormMethod.Post, New With {.autocomplete = "off"})

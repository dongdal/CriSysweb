...
@Code
    ViewBag.Title = Resource.CreateTypeChamps
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateTypeChamps</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeChamps</div>
            <hr>
            @Using Html.BeginForm("Create", "TypeChamps", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.DeleteTypeChamps
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeChamps</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeChamps", FormMethod.Post, New With {.autocomplete = "off"})

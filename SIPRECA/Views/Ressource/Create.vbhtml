...
@Code
    ViewBag.Title = Resource.CreateRessource
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateRessource</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateRessource</div>
            <hr>
            @Using Html.BeginForm("Create", "Ressources", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of Modules)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListModule
    Layout = "~/Views/Shared/_LayoutParam.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageModule</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Modules")>@Resource.ManageModule</a></li>
        <li class="breadcrumb-item active">@Resource.ListModule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListModule</div>
            <hr>
            @Using Html.BeginForm("Index", "Modules", FormMethod.Post, New With {.autocomplete = "off"})
                @Html.AntiForgeryToken()
                @<div Class="form-inline padding-bottom-1">
                    <div Class="row col-sm-12">
                        <div Class="col-sm-8">
                            <div Class="form-group">
                                @If AppSession.ListActionSousRessource.Contains(63, 1) Then
                    ...
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="text-center">
                                @If AppSession.ListActionSousRessource.Contains(63, 3) Then

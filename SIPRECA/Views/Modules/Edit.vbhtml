...
@Code
    ViewBag.Title = Resource.EditModule
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditModule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditModule</div>
            <hr>
            @Using Html.BeginForm("Edit", "Modules", FormMethod.Post, New With {.autocomplete = "off"})

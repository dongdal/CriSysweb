@ModelType ModulesViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateModule
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateModule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateModule</div>
            <hr>
            @Using Html.BeginForm("Create", "Modules", FormMethod.Post, New With {.autocomplete = "off"})

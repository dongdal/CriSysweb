...
@Code
    ViewBag.Title = Resource.DeleteCollectiviteSinistree
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteCollectiviteSinistree</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "CollectiviteSinistrees", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                @<div Class="form-group row">
                    ...
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Sinistre.Libelle, New With {.class = "form-control form-control-square", .tabindex = "2", .Placeholder = Resource.ComboSinistre, .readonly = "true"})
                    </div>
                ...
                @<div Class="form-group row">
                    ...
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.AnneeBudgetaire.Libelle, New With {.class = "form-control form-control-square", .tabindex = "4", .Placeholder = Resource.ComboAnneeBudgetaire, .readonly = "true"})
                    </div>
                </div>
                ...
                @<div Class="form-group row">
                    ...
                    @Html.LabelFor(Function(m) m.DateSinistre, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.DateSinistre, New With {.class = "form-control form-control-square", .tabindex = "5", .Placeholder = Resource.DateSinistrePlaceholder, .readonly = "true"})
                    </div>

                    @Html.LabelFor(Function(m) m.DateCreation, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.DateCreation, New With {.class = "form-control form-control-square", .tabindex = "6", .readonly = "true"})
                    </div>
                </div>
                ...
                @<div Class="form-group row">
                    ...
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.AspNetUser.UserName, New With {.class = "form-control form-control-square", .tabindex = "7", .readonly = "true"})
                    </div>
                </div>

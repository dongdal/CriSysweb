@ModelType NiveauDAlertViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.EditNiveauDAlert
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditNiveauDAlert</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditNiveauDAlert</div>
            <hr>
            @Using Html.BeginForm("Edit", "NiveauDAlerts", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of NiveauDAlert)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListNiveauDAlert
    Layout = "~/Views/Shared/_LayoutDesinventar.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageNiveauDAlert</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "NiveauDAlerts")>@Resource.ManageNiveauDAlert</a></li>
        <li class="breadcrumb-item active">@Resource.ListNiveauDAlert</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListNiveauDAlert</div>
            <hr>
            @Using Html.BeginForm("Index", "NiveauDAlerts", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.DeleteQuartier
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteQuartier</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "Quartiers", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                @<div Class="form-group row">
                    ...
                    @Html.LabelFor(Function(m) m.Commune.Libelle, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Commune.Libelle, New With {.class = "form-control form-control-square", .tabindex = "2", .Placeholder = Resource.CommuneCombo, .readonly = "true"})
                    </div>
                </div>
                ...
                @<div Class="form-group row">
                    ...
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Code, New With {.class = "form-control form-control-square", .tabindex = "5", .Placeholder = Resource.SuperficiePlaceholder, .readonly = "true"})

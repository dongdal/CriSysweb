...
@Code
    ViewBag.Title = Resource.EditQuartier
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditQuartier</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditQuartier</div>
            <hr>
            @Using Html.BeginForm("Edit", "Quartiers", FormMethod.Post, New With {.autocomplete = "off"})

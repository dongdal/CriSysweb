...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("QueryResult", "EvenementZones", FormMethod.Post, New With {.autocomplete = "off"})
                    ...
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-round btn-info waves-effect waves-light m-1" title="@Resource.Btn_Detail" href="@Url.Action("QueryResultDetailed", New With {.EvenementZoneId = item.Id})">

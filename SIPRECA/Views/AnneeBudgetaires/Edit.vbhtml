...
@Code
    ViewBag.Title = Resource.EditTypeAnneeBudgetaire
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeAnneeBudgetaire</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeAnneeBudgetaire</div>
            <hr>
            @Using Html.BeginForm("Edit", "AnneeBudgetaires", FormMethod.Post, New With {.autocomplete = "off"})

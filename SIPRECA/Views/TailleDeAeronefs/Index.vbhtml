@ModelType PagedList.IPagedList(Of TailleDeAeronef)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListTailleDeAeronef
    Layout = "~/Views/Shared/_LayoutSahana.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageTailleDeAeronef</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TailleDeAeronefs")>@Resource.ManageTailleDeAeronef</a></li>
        <li class="breadcrumb-item active">@Resource.ListTailleDeAeronef</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTailleDeAeronef</div>
            <hr>
            @Using Html.BeginForm("Index", "TailleDeAeronefs", FormMethod.Post, New With {.autocomplete = "off"})
                @Html.AntiForgeryToken()
                @<div Class="form-inline padding-bottom-1">
                    <div Class="row col-sm-12">
                        <div Class="col-sm-8">
                            <div Class="form-group">
                                @If AppSession.ListActionSousRessource.Contains(28, 1) Then
                    ...
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="text-center">
                                @If AppSession.ListActionSousRessource.Contains(28, 3) Then

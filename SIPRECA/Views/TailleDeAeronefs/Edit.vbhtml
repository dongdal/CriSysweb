...
@Code
    ViewBag.Title = Resource.EditTailleDeAeronef
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTailleDeAeronef</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTailleDeAeronef</div>
            <hr>
            @Using Html.BeginForm("Edit", "TailleDeAeronef", FormMethod.Post, New With {.autocomplete = "off"})

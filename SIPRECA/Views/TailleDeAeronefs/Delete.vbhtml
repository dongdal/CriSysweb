...
@Code
    ViewBag.Title = Resource.DeleteTailleDeAeronef
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTailleDeAeronef</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TailleDeAeronefs", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of Entrepots)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListEntrepot
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListEntrepot</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListEntrepot</div>
            <hr>
            @Using Html.BeginForm("Index", "Entrepots", FormMethod.Post, New With {.autocomplete = "off"})

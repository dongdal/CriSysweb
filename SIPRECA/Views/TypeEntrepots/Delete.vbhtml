...
@Code
    ViewBag.Title = Resource.DeleteTypeEntrepot
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeEntrepot</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeEntrepots", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of TypeEntrepot)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListTypeEntrepot
    Layout = "~/Views/Shared/_LayoutSahana.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageTypeEntrepot</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeEntrepots")>@Resource.ManageTypeEntrepot</a></li>
        <li class="breadcrumb-item active">@Resource.ListTypeEntrepot</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTypeEntrepot</div>
            <hr>
            @Using Html.BeginForm("Index", "TypeEntrepots", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of Ressource)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListRessource
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListRessource</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListRessource</div>
            <hr>
            @Using Html.BeginForm("Index", "Ressources", FormMethod.Post, New With {.autocomplete = "off"})

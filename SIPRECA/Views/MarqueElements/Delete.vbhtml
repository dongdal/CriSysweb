...
@Code
    ViewBag.Title = Resource.DeleteMarqueElement
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteMarqueElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "MarqueElements", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType MarqueElementViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateMarqueElement
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateMarqueElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateMarqueElement</div>
            <hr>
            @Using Html.BeginForm("Create", "MarqueElements", FormMethod.Post, New With {.autocomplete = "off"})

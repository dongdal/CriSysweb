...
@Code
    ViewBag.Title = Resource.EditMarqueElement
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditMarqueElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditMarqueElement</div>
            <hr>
            @Using Html.BeginForm("Edit", "MarqueElements", FormMethod.Post, New With {.autocomplete = "off"})

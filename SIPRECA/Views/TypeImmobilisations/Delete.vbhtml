...
@Code
    ViewBag.Title = Resource.DeleteTypeImmobilisation
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeImmobilisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeImmobilisations", FormMethod.Post, New With {.autocomplete = "off"})

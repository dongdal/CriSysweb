...
@Code
    ViewBag.Title = Resource.EditTypeImmobilisation
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeImmobilisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeImmobilisation</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeImmobilisations", FormMethod.Post, New With {.autocomplete = "off"})

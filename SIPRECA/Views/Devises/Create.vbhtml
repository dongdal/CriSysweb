@ModelType DeviseViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateDevise
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateDevise</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateDevise</div>
            <hr>
            @Using Html.BeginForm("Create", "Devises", FormMethod.Post, New With {.autocomplete = "off"})

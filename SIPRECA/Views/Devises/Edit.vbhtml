...
@Code
    ViewBag.Title = Resource.EditDevise
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditDevise</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditDevise</div>
            <hr>
            @Using Html.BeginForm("Edit", "Devises", FormMethod.Post, New With {.autocomplete = "off"})

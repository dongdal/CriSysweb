...
@Code
    ViewBag.Title = Resource.EditImmobilisation
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditImmobilisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditImmobilisation</div>
            <hr>
            @Using Html.BeginForm("Edit", "Immobilisations", FormMethod.Post, New With {.autocomplete = "off"})

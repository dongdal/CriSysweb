@ModelType PagedList.IPagedList(Of TypeHopitaux)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListTypeHopitaux
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeHopitaux")>@Resource.ManageTypeHopitaux</a></li>
        <li class="breadcrumb-item active">@Resource.ListTypeHopitaux</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTypeHopitaux</div>
            <hr>
            @Using Html.BeginForm("Index", "TypeHopitaux", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.EditTypeHopitaux
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeHopitaux</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeHopitaux</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeHopitaux", FormMethod.Post, New With {.autocomplete = "off"})

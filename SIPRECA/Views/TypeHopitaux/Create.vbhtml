@ModelType TypeHopitauxViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateTypeHopitaux
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateTypeHopitaux</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeHopitaux</div>
            <hr>
            @Using Html.BeginForm("Create", "TypeHopitaux", FormMethod.Post, New With {.autocomplete = "off"})

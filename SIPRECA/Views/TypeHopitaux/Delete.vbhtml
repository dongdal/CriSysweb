...
@Code
    ViewBag.Title = Resource.DeleteTypeHopitaux
End Code



<div class="page-header">
    <h1 class="page-title">@Resource.ManageTypeHopitaux</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeHopitaux")>@Resource.ManageTypeHopitaux</a></li>
        <li class="breadcrumb-item active">@Resource.DeleteTypeHopitaux</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeHopitaux", FormMethod.Post, New With {.autocomplete = "off"})

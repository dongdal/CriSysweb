...
@Code
    ViewBag.Title = Resource.SendMail
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.SendMail</div>
            <hr>
            @Using Html.BeginForm("SendMail", "Alerts", FormMethod.Post, New With {.autocomplete = "off", .id = "__AjaxAntiForgeryForm"})
...
New With {.class = "form-control multiple-select", .tabindex = "4", .Placeholder = Resource.CommuneCombo, .multiple = "multiple"})
                ...
                @<div Class="form-group row">
                    ...
                    <div class="col-sm-10">
                        @Html.TextAreaFor(Function(m) m.Contenu, New With {.class = "form-control form-control-square summernoteEditor", .tabindex = "4",
.Placeholder = Resource.ContenuPlaceholde})
                ...
                @<div Class="form-group row">
                    ...
                    <div Class="col-sm-10">
                        ...
                        <Button type="button" onclick="SendingMail();" Class="btn btn-primary waves-effect waves-light m-1">

@ModelType PagedList.IPagedList(Of Installation)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListInstallation
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListInstallation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListInstallation</div>
            <hr>
            @Using Html.BeginForm("Index", "Installations", FormMethod.Post, New With {.autocomplete = "off"})

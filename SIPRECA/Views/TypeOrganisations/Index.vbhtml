@ModelType PagedList.IPagedList(Of TypeOrganisation)
...
<div class="page-header">
    <h1 class="page-title">@Resource.ManageTypeOrganisation</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeOrganisations")>@Resource.ManageTypeOrganisation</a></li>
        <li class="breadcrumb-item active">@Resource.ListTypeOrganisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTypeOrganisation</div>
            <hr>
            @Using Html.BeginForm("Index", "TypeOrganisations", FormMethod.Post, New With {.autocomplete = "off"})
                @Html.AntiForgeryToken()
                @<div Class="form-inline padding-bottom-1">
                    <div Class="row col-sm-12">
                        <div Class="col-sm-8">
                            <div Class="form-group">
                                @If AppSession.ListActionSousRessource.Contains(19, 1) Then
                    ...
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="text-center">
                                @If AppSession.ListActionSousRessource.Contains(19, 3) Then
                                ...
                                End If
                                @If AppSession.ListActionSousRessource.Contains(19, 4) Then

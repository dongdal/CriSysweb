...
@Code
    ViewBag.Title = Resource.EditTypeOrganisation
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeOrganisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeOrganisation</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeOrganisations", FormMethod.Post, New With {.autocomplete = "off"})

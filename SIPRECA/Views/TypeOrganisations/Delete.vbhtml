...
@Code
    ViewBag.Title = Resource.DeleteTypeOrganisation
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeOrganisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeOrganisations", FormMethod.Post, New With {.autocomplete = "off"})

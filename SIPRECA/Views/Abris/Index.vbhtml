@ModelType PagedList.IPagedList(Of Abris)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListAbris
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListAbris</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListAbris</div>
            <hr>
            @Using Html.BeginForm("Index", "Abris", FormMethod.Post, New With {.autocomplete = "off"})
            ...
            <table id="default-datatable" class="table table-bordered dataTable" role="grid" aria-describedby="default-datatable_info">
                <thead>
                    <tr>
                        ...
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.TypeAbris, "Index", New With {.sortOrder = ViewBag.TypeHopitauxSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.EstimationPopulation, "Index", New With {.sortOrder = ViewBag.NombreDeLitMinSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.Capacite, "Index", New With {.sortOrder = ViewBag.NombreDeLitMaxSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Resource.ActionList
                        </th>
                ...
                <tbody>
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="sorting_asc text-center">
                                @Html.DisplayFor(Function(modelItem) item.TypeAbris.Libelle)
                            </td>
                            <td class="sorting_asc text-center">
                                @Html.DisplayFor(Function(modelItem) item.EstimationPopulation)
                            <td class="sorting_asc text-center">

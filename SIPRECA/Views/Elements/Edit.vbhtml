...
@Code
    ViewBag.Title = Resource.EditElement
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditElement</div>
            <hr>
            @Using Html.BeginForm("Edit", "Elements", FormMethod.Post, New With {.autocomplete = "off"})

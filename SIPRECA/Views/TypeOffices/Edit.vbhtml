...
@Code
    ViewBag.Title = Resource.EditTypeOffice
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeOffice</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeOffice</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeOffices", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.DeleteTypeOffice
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeOffice</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeOffices", FormMethod.Post, New With {.autocomplete = "off"})

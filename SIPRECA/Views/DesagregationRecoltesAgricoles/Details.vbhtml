@ModelType SIPRECA.DesagregationRecoltesAgricole
@Code
...
<div>
    <h4>DesagregationRecoltesAgricole</h4>
    <hr />
    <dl class="dl-horizontal">
        ...
        <dt>
            @Html.DisplayNameFor(Function(model) model.Libellle)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.Libellle)
        </dd>

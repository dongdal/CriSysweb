...
@Code
    ViewBag.Title = Resource.EditDesagregationRecoltesAgricole
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditDesagregationRecoltesAgricole</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditDesagregationRecoltesAgricole</div>
            <hr>
            @Using Html.BeginForm("Edit", "DesagregationRecoltesAgricoles", FormMethod.Post, New With {.autocomplete = "off"})

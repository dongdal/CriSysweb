...
@Code
    ViewBag.Title = Resource.EditTypeAbris
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeAbris</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeAbris</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeAbris", FormMethod.Post, New With {.autocomplete = "off"})

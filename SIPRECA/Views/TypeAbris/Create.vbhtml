@ModelType TypeAbrisViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateTypeAbris
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateTypeAbris</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeAbris</div>
            <hr>
            @Using Html.BeginForm("Create", "TypeAbris", FormMethod.Post, New With {.autocomplete = "off"})

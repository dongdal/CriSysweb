...
@Code
    ViewBag.Title = Resource.EditPersonnel
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditPersonnel</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditPersonnel</div>
            <hr>
            @Using Html.BeginForm("Edit", "Personnels", FormMethod.Post, New With {.autocomplete = "off"})

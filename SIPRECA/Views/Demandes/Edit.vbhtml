...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditDemande</div>
            <hr>
            @Using Html.BeginForm("Edit", "Demandes", FormMethod.Post, New With {.autocomplete = "off"})

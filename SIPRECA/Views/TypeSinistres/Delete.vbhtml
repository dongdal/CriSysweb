...
@Code
    ViewBag.Title = Resource.DeleteTypeSinistre
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeSinistre</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeSinistres", FormMethod.Post, New With {.autocomplete = "off"})

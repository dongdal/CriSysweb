@ModelType PagedList.IPagedList(Of TypeSinistre)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListTypeSinistre
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeSinistres")>@Resource.ManageTypeSinistre</a></li>
        <li class="breadcrumb-item active">@Resource.ListTypeSinistre</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTypeSinistre</div>
            <hr>
            @Using Html.BeginForm("Index", "TypeSinistres", FormMethod.Post, New With {.autocomplete = "off"})

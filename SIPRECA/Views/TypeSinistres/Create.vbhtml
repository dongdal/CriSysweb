...
@Code
    ViewBag.Title = Resource.CreateTypeSinistre
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateTypeSinistre</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeSinistre</div>
            <hr>
            @Using Html.BeginForm("Create", "TypeSinistres", FormMethod.Post, New With {.autocomplete = "off"})

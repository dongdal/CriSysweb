...
@Code
    ViewBag.Title = Resource.DeleteCategorieElement
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteCategorieElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "CategorieElements", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.EditCategorieElement
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeSuivi</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditCategorieElement</div>
            <hr>
            @Using Html.BeginForm("Edit", "CategorieElements", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of CategorieElement)
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListCategorieElement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListCategorieElement</div>
            <hr>
            @Using Html.BeginForm("Index", "CategorieElements", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of CategorieDArticle)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListCategorieDArticle
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageCategorieDArticle</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "CategorieDArticles")>@Resource.ManageCategorieDArticle</a></li>
        <li class="breadcrumb-item active">@Resource.ListCategorieDArticle</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListCategorieDArticle</div>
            <hr>
            @Using Html.BeginForm("Index", "CategorieDArticles", FormMethod.Post, New With {.autocomplete = "off"})

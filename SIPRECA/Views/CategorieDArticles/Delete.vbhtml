...
@Code
    ViewBag.Title = Resource.DeleteCategorieDArticle
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteCategorieDArticle</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "CategorieDArticles", FormMethod.Post, New With {.autocomplete = "off"})

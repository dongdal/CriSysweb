...
@Code
    ViewBag.Title = Resource.EditCategorieDArticle
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditCategorieDArticle</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditCategorieDArticle</div>
            <hr>
            @Using Html.BeginForm("Edit", "CategorieDArticles", FormMethod.Post, New With {.autocomplete = "off"})

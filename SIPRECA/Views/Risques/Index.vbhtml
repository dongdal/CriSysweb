@ModelType PagedList.IPagedList(Of Risque)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListRisque
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListRisque</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListRisque</div>
            <hr>
            @Using Html.BeginForm("Index", "Risques", FormMethod.Post, New With {.autocomplete = "off"})

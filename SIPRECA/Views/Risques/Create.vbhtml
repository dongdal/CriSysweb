@ModelType RisqueViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateRisque
...
<div class="page-header">
    <h1 class="page-title">@Resource.ManageRisque</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Risques")>@Resource.ManageRisque</a></li>
        <li class="breadcrumb-item active">@Resource.CreateRisque</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateRisque</div>
            <hr>
            @Using Html.BeginForm("Create", "Risques", FormMethod.Post, New With {.autocomplete = "off"})

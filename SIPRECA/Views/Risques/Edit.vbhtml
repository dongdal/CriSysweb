...
@Code
    ViewBag.Title = Resource.EditRisque
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditRisque</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditRisque</div>
            <hr>
            @Using Html.BeginForm("Edit", "Risques", FormMethod.Post, New With {.autocomplete = "off"})

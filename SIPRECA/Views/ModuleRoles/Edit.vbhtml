...
@Code
    ViewBag.Title = Resource.EditModuleRole
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditModuleRole</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditModuleRole</div>
            <hr>
            @Using Html.BeginForm("Edit", "ModuleRoles", FormMethod.Post, New With {.autocomplete = "off"})

                ...
                @<div Class="form-group row">
                    ...
                    <div Class="col-sm-10">
                        @If Not (Model.StatutExistant = Util.ElementsSuiviDemandes.DecisionIndemnisation) Then
                            @<Button type="submit" name="AddDetailsIndemnisation" Class="btn btn-link btn-square bg-purple text-dark shadow px-5"><i Class="icon-lock"></i> @Resource.AddItem</Button>
                        End If

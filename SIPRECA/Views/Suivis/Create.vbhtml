...
@Code
    ViewBag.Title = Resource.CreateSuivi
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateSuivi</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateSuivi</div>
            <hr>
            @Using Html.BeginForm("Create", "Suivis", FormMethod.Post, New With {.autocomplete = "off"})
...
New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.ComboDemande})
 ...
 New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.ComboTypeSuivi})
                        @Html.ValidationMessageFor(Function(m) m.TypeSuiviId, "", New With {.style = "color: #da0b0b"})
                    </div>
                </div>

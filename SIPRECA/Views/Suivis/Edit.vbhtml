...
@Code
    ViewBag.Title = Resource.EditSuivi
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditSuivi</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditSuivi</div>
            <hr>
            @Using Html.BeginForm("Edit", "Suivis", FormMethod.Post, New With {.autocomplete = "off"})

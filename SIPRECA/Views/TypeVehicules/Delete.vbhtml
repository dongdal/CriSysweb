...
@Code
    ViewBag.Title = Resource.DeleteTypeVehicule
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypeVehicule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypeVehicules", FormMethod.Post, New With {.autocomplete = "off"})

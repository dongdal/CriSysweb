@ModelType TypeVehiculeViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.EditTypeVehicule
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeVehicule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeSuivi</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeVehicules", FormMethod.Post, New With {.autocomplete = "off"})

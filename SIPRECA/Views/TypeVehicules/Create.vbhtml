...
@Code
    ViewBag.Title = Resource.CreateTypeVehicule
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "TypeSuivis")>@Resource.ManageTypeVehicule</a></li>
        <li class="breadcrumb-item active">@Resource.CreateTypeVehicule</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeVehicule</div>
            <hr>

@ModelType PagedList.IPagedList(Of ZoneARisque)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListZoneARisque
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListZoneARisque</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListZoneARisque</div>
            <hr>
            @Using Html.BeginForm("Index", "ZoneARisques", FormMethod.Post, New With {.autocomplete = "off"})

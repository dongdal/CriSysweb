@ModelType PagedList.IPagedList(Of Materiel)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListMateriel
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListMateriel</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListMateriel</div>
            <hr>
            @Using Html.BeginForm("Index", "Materiels", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                <tbody>
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="sorting_asc text-center">
                                @if item.Cible = 1 Then
                                    @Resource.Hopitaux
                                ElseIf item.Cible = 2 Then
                                    @Resource.Abris
                                ElseIf item.Cible = 3 Then
                                    @Resource.Heliport
                                ElseIf item.Cible = 4 Then
                                    @Resource.PortDeMer
                                ElseIf item.Cible = 5 Then
                                    @Resource.Aeroport
                                ElseIf item.Cible = 6 Then
                                    @Resource.Bureau
                                ElseIf item.Cible = 7 Then
                                    @Resource.Instalation

...
@Code
    ViewBag.Title = Resource.EditFacteur
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditFacteur</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditFacteur</div>
            <hr>
            @Using Html.BeginForm("Edit", "Facteurs", FormMethod.Post, New With {.autocomplete = "off"})

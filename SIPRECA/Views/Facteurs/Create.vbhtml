@ModelType FacteurViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateFacteur
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateFacteur</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateFacteur</div>
            <hr>
            @Using Html.BeginForm("Create", "Facteurs", FormMethod.Post, New With {.autocomplete = "off"})

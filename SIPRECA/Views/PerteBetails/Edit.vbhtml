...
@Code
    ViewBag.Title = Resource.EditPerteBetail
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditPerteBetail</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditPerteBetail</div>
            <hr>
            @Using Html.BeginForm("Edit", "PerteBetails", FormMethod.Post, New With {.autocomplete = "off"})

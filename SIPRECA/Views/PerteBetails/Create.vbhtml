...
@Code
    ViewBag.Title = Resource.CreatePerteBetail
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreatePerteBetail</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreatePerteBetail</div>
            <hr>
            @Using Html.BeginForm("Create", "PerteBetails", FormMethod.Post, New With {.autocomplete = "off"})

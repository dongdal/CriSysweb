@ModelType PagedList.IPagedList(Of NatureAide)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListNatureAide
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListNatureAide</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListNatureAide</div>
            <hr>
            @Using Html.BeginForm("Index", "NatureAides", FormMethod.Post, New With {.autocomplete = "off"})
            ...
            <table id="default-datatable" class="table table-bordered dataTable" role="grid" aria-describedby="default-datatable_info">
                <thead>
                    <tr>
                        ...
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.NatureAideType, "Index", New With {.sortOrder = ViewBag.TypeAideSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                ...
                <tbody>
                    @For Each item In Model
                        @<tr>
                            ...
                            <td class="sorting_asc text-center">
                                @Html.DisplayFor(Function(modelItem) item.TypeAide.Libelle)
                            </td>
                            <td class="sorting_asc text-center">

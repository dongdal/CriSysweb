...
@Code
    ViewBag.Title = Resource.DeleteNatureAide
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteNatureAide</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "NatureAides", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                @<div Class="form-group row">
                    ...
                    @Html.LabelFor(Function(m) m.TypeAide.Libelle, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.TypeAide.Libelle, New With {.class = "form-control form-control-square", .tabindex = "2", .readonly = "true"})
                    </div>
                </div>

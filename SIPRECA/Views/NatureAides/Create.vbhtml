...
@Code
    ViewBag.Title = Resource.CreateNatureAide
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateNatureAide</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateNatureAide</div>
            <hr>
            @Using Html.BeginForm("Create", "NatureAides", FormMethod.Post, New With {.autocomplete = "off"})

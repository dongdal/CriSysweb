...
@Code
    ViewBag.Title = Resource.EditTypeAide
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeAide</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeAide</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeAides", FormMethod.Post, New With {.autocomplete = "off"})

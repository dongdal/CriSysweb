...
@Code
    ViewBag.Title = Resource.CreateEvenement
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateEvenement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateEvenement</div>
            <hr>
            @Using Html.BeginForm("Create", "Evenements", FormMethod.Post, New With {.autocomplete = "off"})

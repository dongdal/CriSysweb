@ModelType PagedList.IPagedList(Of UsageHumanitaire)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListUsageHumanitaire
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "UsageHumanitaires")>@Resource.ManageUsageHumanitaire</a></li>
        <li class="breadcrumb-item active">@Resource.ListUsageHumanitaire</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListUsageHumanitaire</div>
            <hr>
            @Using Html.BeginForm("Index", "UsageHumanitaires", FormMethod.Post, New With {.autocomplete = "off"})

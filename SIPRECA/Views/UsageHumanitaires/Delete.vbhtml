...
@Code
    ViewBag.Title = Resource.DeleteUsageHumanitaire
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteUsageHumanitaire</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "UsageHumanitaires", FormMethod.Post, New With {.autocomplete = "off"})

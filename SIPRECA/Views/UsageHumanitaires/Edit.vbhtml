@ModelType TypeSuiviViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.EditUsageHumanitaire
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditUsageHumanitaire</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditUsageHumanitaire</div>
            <hr>
            @Using Html.BeginForm("Edit", "UsageHumanitaires", FormMethod.Post, New With {.autocomplete = "off"})

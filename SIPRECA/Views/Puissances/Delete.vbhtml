...
@Code
    ViewBag.Title = Resource.DeletePuissance
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeletePuissance</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "Puissances", FormMethod.Post, New With {.autocomplete = "off"})

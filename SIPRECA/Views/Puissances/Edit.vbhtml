...
@Code
    ViewBag.Title = Resource.EditPuissance
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditPuissance</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditPuissance</div>
            <hr>
            @Using Html.BeginForm("Edit", "Puissances", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of Puissance)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListPuissance
    Layout = "~/Views/Shared/_LayoutSahana.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManagePuissance</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Puissances")>@Resource.ManagePuissance</a></li>
        <li class="breadcrumb-item active">@Resource.ListPuissance</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListPuissance</div>
            <hr>
            @Using Html.BeginForm("Index", "Puissances", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.EditTypePersonnel
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypePersonnel</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypePersonnel</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypePersonnels", FormMethod.Post, New With {.autocomplete = "off"})

...
@Code
    ViewBag.Title = Resource.DeleteTypePersonnel
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteTypePersonnel</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "TypePersonnels", FormMethod.Post, New With {.autocomplete = "off"})

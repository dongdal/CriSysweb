...
@Code
    ViewBag.Title = Resource.DetailsHeliports
...
<div class="page-header">
    <h1 class="page-title">@Resource.DetailsHeliports</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Heliports")>@Resource.ManageHeliport</a></li>
        <li class="breadcrumb-item active">@Resource.DetailsHeliports</li>
    </ol>
</div>
    ...
    <div class="card">
        <div class="card-body">
            <ul Class="nav nav-tabs nav-tabs-primary">
                <li Class="nav-item">
                    <a Class="nav-link active" data-toggle="tab" href="#tabe-1"><i class="icon-home"></i> <span class="hidden-xs">@Resource.DetailsHeliports</span></a>
                </li>
                <li Class="nav-item">
                ...
                <div id="tabe-1" class="container tab-pane active">
                    ...
                    <div Class="form-group row">
                        ...
                        <div Class="col-sm-10">
                            <br />
                            <br />
                            @Html.ActionLink(Resource.BtnCancel, "Index", "Heliports", New With {.class = "btn btn-link btn-square bg-white text-dark shadow px-5"})
                        </div>
                    </div>
                </div>

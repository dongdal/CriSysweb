            ...
            <div Class="card">
                <div Class="card-body">
                    <ul Class="nav nav-tabs nav-tabs-primary">
                        <li Class="nav-item">
                            <a Class="nav-link active" data-toggle="tab" href="#tabe-1"><i class="icon-home"></i> <span class="hidden-xs">@Resource.Heliport</span></a>
                        </li>
                        <li Class="nav-item">
                    ...
                    <div class="tab-content">
                        <div id="tabe-1" class="container tab-pane active">
                          ...
                          New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.VilleCombo})
                            ...
                            <div Class="form-group row">
                                ...
                                <div Class="col-sm-10">
                                    <Button type="button" onclick="EditHeliport();" Class="btn btn-link btn-square bg-primary text-dark shadow px-5"><i Class="icon-lock"></i> @Resource.Btn_Edit</Button>
                                    &nbsp;&nbsp;&nbsp;
                        ...
                        <div id="tabe-2" class="container tab-pane fade">
                            ...
                            <div Class="form-group row">
                                @Html.LabelFor(Function(m) m.MaterielHeliportId, New With {.class = "col-sm-2 col-form-label required_field"})
                                <div class="col-sm-4 form-group">
                                    @Html.DropDownListFor(Function(m) m.MaterielHeliportId, New SelectList(Model.LesMaterielHeliports, "Value", "Text"), Resource.ComboMateriel,
New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.ComboMateriel})
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @For Each item In Model.MaterielHeliports
                                        @<tr>
    ...
    <script>
        ...
        function EditHeliport() {
                ...
                if (typeof $(Code).val() == "undefined" || $(Code).val() == "" || typeof $(Nom).val() == "undefined" || $(Nom).val() == "" ||typeof $(VilleId).val() == "undefined" || $(VilleId).val() == "" ||typeof $(OrganisationId).val() == "undefined" || $(OrganisationId).val() == "" || typeof $(Telephone).val() == "undefined" || $(Telephone).val() == "" ) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '@Url.Action("EditHeliport", "Heliports")',
                        dataType: "json",

            ...
            <div Class="card">
                <div Class="card-body">
                    <ul Class="nav nav-tabs nav-tabs-primary">
                        <li Class="nav-item">
                            <a Class="nav-link active" data-toggle="tab" href="#tabe-1"><i class="icon-home"></i> <span class="hidden-xs">Héliport</span></a>
                        </li>
                        <li Class="nav-item">
                        ...
                        <div id="tabe-1" class="container tab-pane active">
                          ...
                          New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.VilleCombo})
                            ...
                            <div Class="form-group row">
                                ...
                                <div Class="col-sm-10">
                                    <Button type="submit" onclick="EditHeliport();" Class="btn btn-link btn-square bg-primary text-dark shadow px-5"><i Class="icon-lock"></i> @Resource.Btn_Edit</Button>
                                    &nbsp;&nbsp;&nbsp;

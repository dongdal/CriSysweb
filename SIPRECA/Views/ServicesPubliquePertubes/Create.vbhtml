...
@Code
    ViewBag.Title = Resource.CreateServicesPubliquePertube
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateServicesPubliquePertube</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateServicesPubliquePertube</div>
            <hr>
            @Using Html.BeginForm("Create", "ServicesPubliquePertubes", FormMethod.Post, New With {.autocomplete = "off"})

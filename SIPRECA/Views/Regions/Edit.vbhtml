...
@Code
    ViewBag.Title = Resource.EditRegion
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditRegion</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditRegion</div>
            <hr>
            @Using Html.BeginForm("Edit", "Regions", FormMethod.Post, New With {.autocomplete = "off"})

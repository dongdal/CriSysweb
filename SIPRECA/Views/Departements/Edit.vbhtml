...
@Code
    ViewBag.Title = Resource.EditDepartement
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditDepartement</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditDepartement</div>
            <hr>
            @Using Html.BeginForm("Edit", "Departements", FormMethod.Post, New With {.autocomplete = "off"})

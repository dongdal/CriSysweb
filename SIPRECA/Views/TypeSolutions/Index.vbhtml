@ModelType PagedList.IPagedList(Of TypeSolution)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListTypeSolution
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListTypeSolution</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListTypeSolution</div>
            <hr>
            @Using Html.BeginForm("Index", "TypeSolutions", FormMethod.Post, New With {.autocomplete = "off"})

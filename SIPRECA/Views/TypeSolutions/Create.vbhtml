...
@Code
    ViewBag.Title = Resource.CreateTypeSolution
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateTypeSolution</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateTypeSolution</div>
            <hr>
            @Using Html.BeginForm("Create", "TypeSolutions", FormMethod.Post, New With {.autocomplete = "off"})

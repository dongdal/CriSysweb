...
@Code
    ViewBag.Title = Resource.EditTypeSolution
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditTypeSolution</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditTypeSolution</div>
            <hr>
            @Using Html.BeginForm("Edit", "TypeSolutions", FormMethod.Post, New With {.autocomplete = "off"})

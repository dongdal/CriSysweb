...
@Code
    ViewBag.Title = Resource.EditBordereauTransfert
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditBordereauTransfert</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditBordereauTransfert</div>
            <hr>
            @Using Html.BeginForm("Edit", "BordereauTransferts", FormMethod.Post, New With {.autocomplete = "off"})

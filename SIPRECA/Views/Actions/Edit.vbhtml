@ModelType ActionsViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.EditActions
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditActions</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditActions</div>
            <hr>
            @Using Html.BeginForm("Edit", "Actions", FormMethod.Post, New With {.autocomplete = "off"})

@ModelType PagedList.IPagedList(Of Actions)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListActions
    Layout = "~/Views/Shared/_LayoutParam.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageActions</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Actions")>@Resource.ManageActions</a></li>
        <li class="breadcrumb-item active">@Resource.ListActions</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListActions</div>
            <hr>
            @Using Html.BeginForm("Index", "Actions", FormMethod.Post, New With {.autocomplete = "off"})

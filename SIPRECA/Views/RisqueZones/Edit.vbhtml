...
@Code
    ViewBag.Title = Resource.EditRisqueZone
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditRisqueZone</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditRisqueZone</div>
            <hr>
            @Using Html.BeginForm("Edit", "RisqueZones", FormMethod.Post, New With {.autocomplete = "off"})

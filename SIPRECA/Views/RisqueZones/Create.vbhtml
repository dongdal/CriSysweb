@ModelType RisqueZoneViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateRisqueZone
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateRisqueZone</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateRisqueZone</div>
            <hr>
            @Using Html.BeginForm("Create", "RisqueZones", FormMethod.Post, New With {.autocomplete = "off"})
       ...
       New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.RisqueCombo})
                    ...
                    <div class="col-sm-4 form-group">
                        @Html.DropDownListFor(Function(m) m.ZoneARisqueId, New SelectList(Model.LesZoneARisques, "Value", "Text"), Resource.ZoneARisqueCombo,
New With {.class = "form-control single-select", .tabindex = "2", .Placeholder = Resource.ZoneARisqueCombo})

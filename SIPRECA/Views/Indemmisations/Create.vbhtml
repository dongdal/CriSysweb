...
@Code
    ViewBag.Title = Resource.CreateIndemmisation
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateIndemmisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateIndemmisation</div>
            <hr>
            @Using Html.BeginForm("Create", "Indemmisations", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                @<div Class="form-group row">
                    ...
                    @Html.LabelFor(Function(m) m.DemandetId, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4 form-group">

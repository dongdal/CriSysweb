...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "Indemmisations", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                @<div Class="form-group row">
                    @Html.LabelFor(Function(m) m.Montant, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Montant, New With {.class = "form-control form-control-square", .tabindex = "1", .Placeholder = Resource.LibellePlaceholder, .readonly = "true"})
                    </div>

                    @Html.LabelFor(Function(m) m.Collectivite.Libelle, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Collectivite.Libelle, New With {.class = "form-control form-control-square", .tabindex = "2", .Placeholder = Resource.LibellePlaceholder, .readonly = "true"})
                    </div>
                </div>

                @<div Class="form-group row">

                    @Html.LabelFor(Function(m) m.Demande.Reference, New With {.class = "col-sm-2 col-form-label"})
                    <div class="col-sm-4">
                        @Html.TextBoxFor(Function(m) m.Demande.Reference, New With {.class = "form-control form-control-square", .tabindex = "3", .Placeholder = Resource.LibellePlaceholder, .readonly = "true"})
                    </div>

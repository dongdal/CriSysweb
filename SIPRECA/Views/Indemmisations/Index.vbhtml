@ModelType PagedList.IPagedList(Of Indemmisation)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListIndemnisation
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListIndemnisation</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListIndemnisation</div>
            <hr>
            @Using Html.BeginForm("Index", "Indemmisations", FormMethod.Post, New With {.autocomplete = "off"})
                ...
                <thead>
                    <tr>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.Montant, "Index", New With {.sortOrder = ViewBag.MontantSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                            @Html.ActionLink(Resource.Collectivite, "Index", New With {.sortOrder = ViewBag.CollectiviteSort, .currentFilter = ViewBag.CurrentFilter, .tab = ViewBag.activeTab})
                        </th>
                        <th class="sorting_asc text-center" tabindex="0" aria-controls="datatable-responsive">
                ...
                <tbody>
                    @For Each item In Model
                        ...
                        <td class="sorting_asc text-center">
                            @Html.DisplayFor(Function(modelItem) item.Montant)
                        </td>
                        <td class="sorting_asc text-center">

...
@Code
    ViewBag.Title = Resource.DeleteSurfaceDePiste
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteSurfaceDePiste</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "SurfaceDePistes", FormMethod.Post, New With {.autocomplete = "off"})

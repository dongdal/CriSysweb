@ModelType PagedList.IPagedList(Of SurfaceDePiste)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListSurfaceDePiste
    Layout = "~/Views/Shared/_LayoutSahana.vbhtml"
End Code

<div class="page-header">
    <h1 class="page-title">@Resource.ManageSurfaceDePiste</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "Home")>@Resource.Menu_Home</a></li>
        <li class="breadcrumb-item"><a href=@Url.Action("Index", "SurfaceDePistes")>@Resource.ManageSurfaceDePiste</a></li>
        <li class="breadcrumb-item active">@Resource.ListSurfaceDePiste</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListSurfaceDePiste</div>
            <hr>
            @Using Html.BeginForm("Index", "SurfaceDePistes", FormMethod.Post, New With {.autocomplete = "off"})

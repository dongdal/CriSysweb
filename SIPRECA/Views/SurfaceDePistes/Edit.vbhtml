...
@Code
    ViewBag.Title = Resource.EditSurfaceDePiste
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditSurfaceDePiste</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditSurfaceDePiste</div>
            <hr>
            @Using Html.BeginForm("Edit", "SurfaceDePistes", FormMethod.Post, New With {.autocomplete = "off"})

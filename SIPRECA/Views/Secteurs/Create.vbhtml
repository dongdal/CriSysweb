@ModelType SecteurViewModel
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.CreateSecteur
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.CreateSecteur</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.CreateSecteur</div>
            <hr>
            @Using Html.BeginForm("Create", "Secteurs", FormMethod.Post, New With {.autocomplete = "off"})

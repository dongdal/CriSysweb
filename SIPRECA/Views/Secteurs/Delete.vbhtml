...
@Code
    ViewBag.Title = Resource.DeleteSecteur
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.DeleteSecteur</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            @Using Html.BeginForm("Delete", "Secteurs", FormMethod.Post, New With {.autocomplete = "off"})

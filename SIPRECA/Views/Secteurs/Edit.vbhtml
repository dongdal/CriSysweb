...
@Code
    ViewBag.Title = Resource.EditSecteur
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.EditSecteur</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.EditSecteur</div>
            <hr>
            @Using Html.BeginForm("Edit", "Secteurs", FormMethod.Post, New With {.autocomplete = "off"})

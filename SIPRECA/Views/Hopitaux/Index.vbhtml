@ModelType PagedList.IPagedList(Of Hopitaux)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListHopitaux
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListHopitaux</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListHopitaux</div>
            <hr>
            @Using Html.BeginForm("Index", "Hopitaux", FormMethod.Post, New With {.autocomplete = "off"})

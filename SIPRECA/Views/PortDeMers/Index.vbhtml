@ModelType PagedList.IPagedList(Of PortDeMer)
@Imports PagedList.Mvc
@Imports SIPRECA.My.Resources
@Code
    ViewBag.Title = Resource.ListPortDeMer
End Code
...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@Resource.ListPortDeMer</li>
    </ol>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-uppercase"><i class="fa fa-address-book-o"></i> @Resource.ListPortDeMer</div>
            <hr>
            @Using Html.BeginForm("Index", "PortDeMers", FormMethod.Post, New With {.autocomplete = "off"})

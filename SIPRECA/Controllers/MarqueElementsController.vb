...
Namespace Controllers
    Public Class MarqueElementsController
        ...
        Function Index(sortOrder As String, currentFilter As String, searchString As String, page As Integer?) As ActionResult
            If Not AppSession.ListActionSousRessource.Contains(38, 2) Then
            ...
            Dim entities = (From e In Db.MarqueElement Where e.StatutExistant = 1 Select e)
            If Not String.IsNullOrEmpty(searchString) Then
        ...
        ' GET: MarqueElement/Details/5
        'Function Details(ByVal id As Long?) As ActionResult
        '    If IsNothing(id) Then
        '        Return New HttpStatusCodeResult(HttpStatusCode.BadRequest)
        '    End If
        '    Dim MarqueElement As MarqueElement = Db.MarqueElement.Find(id)
        '    If IsNothing(MarqueElement) Then
        '        Return HttpNotFound()
        '    End If
        '    Return View(MarqueElement)
        'End Function

        Private Sub LoadComboBox(entityVM As MarqueElementViewModel)
        ...
        Function Create() As ActionResult
            If Not AppSession.ListActionSousRessource.Contains(38, 1) Then
                Return RedirectToAction("Error404", "Home", New With {Resource.Error400_AccessRights, .MyAction = "Index", .Controleur = "Home"})
            End If
        ...
        Function Edit(ByVal id As Long?) As ActionResult
            If Not AppSession.ListActionSousRessource.Contains(38, 3) Then
                Return RedirectToAction("Error404", "Home", New With {Resource.Error400_AccessRights, .MyAction = "Index", .Controleur = "Home"})
            End If
            If IsNothing(id) Then
                Return New HttpStatusCodeResult(HttpStatusCode.BadRequest)
            ...
            If IsNothing(MarqueElement) Then
                Return HttpNotFound()
            End If
            Dim entityVM As New MarqueElementViewModel(MarqueElement)
            LoadComboBox(entityVM)
            Return View(entityVM)
        End Function

        ' POST: MarqueElement/Edit/5
        'Afin de déjouer les attaques par sur-validation, activez les propriétés spécifiques que vous voulez lier. Pour 
        'plus de détails, voir  https://go.microsoft.com/fwlink/?LinkId=317598.
        <HttpPost()>
        <ValidateAntiForgeryToken()>
        ...
        Function Delete(ByVal id As Long?) As ActionResult
            If Not AppSession.ListActionSousRessource.Contains(38, 4) Then
                Return RedirectToAction("Error404", "Home", New With {Resource.Error400_AccessRights, .MyAction = "Index", .Controleur = "Home"})
            End If
            If IsNothing(id) Then
                Return New HttpStatusCodeResult(HttpStatusCode.BadRequest)
        ...
        Function DeleteConfirmed(ByVal id As Long) As ActionResult
            ...
            Catch ex As Exception
                Util.GetError(ex, ModelState)
            End Try
            Return View(New MarqueElementViewModel(MarqueElement))
        End Function

...
Namespace Controllers
    Public Class MaterielsController
        ...
        Function Index(sortOrder As String, currentFilter As String, searchString As String, page As Integer?) As ActionResult
            ...
            ViewBag.CibleSort = If(sortOrder = "Cible", "Cible_desc", "Cible")
            ...
            Dim entities = (From e In Db.Materiel Where e.StatutExistant = 1 Select e)
            If Not String.IsNullOrEmpty(searchString) Then
            ...
            Select Case sortOrder
                ...
                Case "Cible"
                    entities = entities.OrderBy(Function(e) e.Cible)
                Case "Cible_desc"
                    entities = entities.OrderByDescending(Function(e) e.Cible)
                Case Else
                    entities = entities.OrderBy(Function(e) e.Libelle)
                    Exit Select
            End Select
        ...
        '    If IsNothing(Materiel) Then
        '        Return HttpNotFound()
        '    End If
        '    Return View(Materiel)
        'End Function

        Private Sub LoadComboBox(entityVM As MaterielViewModel)
        ...
        Function Create(ByVal entityVM As MaterielViewModel) As ActionResult
            ...
            If ModelState.IsValid Then
                Db.Materiel.Add(entityVM.GetEntity)
                Try
                    Db.SaveChanges()
        ...
        Function Edit(ByVal id As Long?) As ActionResult
            ...
            If IsNothing(Materiel) Then
                Return HttpNotFound()
            End If
            Dim entityVM As New MaterielViewModel(Materiel)
            LoadComboBox(entityVM)
            Return View(entityVM)
        End Function
        ...
        Function DeleteConfirmed(ByVal id As Long) As ActionResult
            ...
            Catch ex As Exception
                Util.GetError(ex, ModelState)
            End Try
            Return View(New MaterielViewModel(Materiel))
        End Function

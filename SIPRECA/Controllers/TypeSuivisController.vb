...
Namespace Controllers
    Public Class TypeSuivisController
        ...
        Function Index(sortOrder As String, currentFilter As String, searchString As String, page As Integer?) As ActionResult
            ...
            Dim entities = (From e In Db.TypeSuivi Where e.StatutExistant = 1 Select e)
            If Not String.IsNullOrEmpty(searchString) Then
        ...
        ' GET: TypeSuivi/Details/5
        'Function Details(ByVal id As Long?) As ActionResult
        '    If IsNothing(id) Then
        '        Return New HttpStatusCodeResult(HttpStatusCode.BadRequest)
        '    End If
        '    Dim TypeSuivi As TypeSuivi = Db.TypeSuivi.Find(id)
        '    If IsNothing(TypeSuivi) Then
        '        Return HttpNotFound()
        '    End If
        '    Return View(TypeSuivi)
        'End Function

        Private Sub LoadComboBox(entityVM As TypeSuiviViewModel)
        ...
        Function Create(ByVal entityVM As TypeSuiviViewModel) As ActionResult
            ...
            If ModelState.IsValid Then
                Db.TypeSuivi.Add(entityVM.GetEntity)
                Try
                    Db.SaveChanges()
        ...
        Function Edit(ByVal id As Long?) As ActionResult
            ...
            If IsNothing(TypeSuivi) Then
                Return HttpNotFound()
            End If
            Dim entityVM As New TypeSuiviViewModel(TypeSuivi)
            LoadComboBox(entityVM)
            Return View(entityVM)
        End Function

        ' POST: TypeSuivi/Edit/5
        'Afin de déjouer les attaques par sur-validation, activez les propriétés spécifiques que vous voulez lier. Pour 
        'plus de détails, voir  https://go.microsoft.com/fwlink/?LinkId=317598.
        <HttpPost()>
        <ValidateAntiForgeryToken()>
        ...
        ' POST: TypeSuivi/Delete/5
        <HttpPost()>
        <ActionName("Delete")>
        <ValidateAntiForgeryToken()>
        Function DeleteConfirmed(ByVal id As Long) As ActionResult
            Dim TypeSuivi As TypeSuivi = Db.TypeSuivi.Find(id)
            Db.TypeSuivi.Remove(TypeSuivi)
            Try
                Db.SaveChanges()
                Return RedirectToAction("Index")
            Catch ex As DbEntityValidationException
            ...
            Catch ex As Exception
                Util.GetError(ex, ModelState)
            End Try
            Return View(New TypeSuiviViewModel(TypeSuivi))
        End Function

...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Ajoutdeladatededeclarationdedemandedindemnisation
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Ajoutdeladatededeclarationdedemandedindemnisation))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201911180857492_Ajout de la date de declaration de demande d'indemnisation"
            End Get
        End Property

...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Modificationdumodelpourajoutduplateautechnique
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Modificationdumodelpourajoutduplateautechnique))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201911041139435_Modification du model pour ajout du plateau technique"
            End Get
        End Property

...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ModificationdesTablespourgestiondesformulaires
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ModificationdesTablespourgestiondesformulaires))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201907291551007_Modification des Tables pour gestion des formulaires"
            End Get
        End Property

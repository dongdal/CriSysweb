...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MiseAJourDuModelPourSahana
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MiseAJourDuModelPourSahana))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201908220944109_MiseAJourDuModelPourSahana"
            End Get
        End Property

...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Update_Table_Orgaisation
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Update_Table_Orgaisation))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201908201141505_Update_Table_Orgaisation"
            End Get
        End Property

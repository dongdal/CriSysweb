...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Remove_Table_AspNetUserActionSousRessource
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Remove_Table_AspNetUserActionSousRessource))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202004061401371_Remove_Table_AspNetUserActionSousRessource"
            End Get
        End Property

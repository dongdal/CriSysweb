...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Villeverscommunemoyendereponse
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Villeverscommunemoyendereponse))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201911201250304_Ville vers commune moyen de reponse"
            End Get
        End Property

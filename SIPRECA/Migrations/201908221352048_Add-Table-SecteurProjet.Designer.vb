...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddTableSecteurProjet
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddTableSecteurProjet))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201908221352048_Add-Table-SecteurProjet"
            End Get
        End Property

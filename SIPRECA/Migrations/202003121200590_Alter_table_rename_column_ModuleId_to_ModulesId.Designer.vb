...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Alter_table_rename_column_ModuleId_to_ModulesId
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Alter_table_rename_column_ModuleId_to_ModulesId))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202003121200590_Alter_table_rename_column_ModuleId_to_ModulesId"
            End Get
        End Property

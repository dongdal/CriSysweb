...
Public Class SurfaceDePisteViewModel
    ...
    Public Sub New(entity As SurfaceDePiste)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As SurfaceDePiste
        Dim entity As New SurfaceDePiste
        With entity
            .Id = Id
            .Libelle = Libelle

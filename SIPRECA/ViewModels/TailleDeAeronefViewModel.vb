...
Public Class TailleDeAeronefViewModel
    ...
    Public Sub New(entity As TailleDeAeronef)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As TailleDeAeronef
        Dim entity As New TailleDeAeronef
        With entity
            .Id = Id
            .Libelle = Libelle

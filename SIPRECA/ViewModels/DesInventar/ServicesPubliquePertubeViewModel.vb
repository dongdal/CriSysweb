...
Public Class ServicesPubliquePertubeViewModel
    ...
    Public Sub New(entity As ServicesPubliquePertube)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As ServicesPubliquePertube
        Dim entity As New ServicesPubliquePertube
        With entity
            .Id = Id
            .Libelle = Libelle

...
Public Class CompetanceViewModel
    ...
    <Display(Name:="Personnel", ResourceType:=GetType(Resource))>
    Public Property PersonnelId As String
    Public Overridable Property LesPersonnels As ICollection(Of SelectListItem)
    ...
    Public Sub New(entity As Competance)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As Competance
        Dim entity As New Competance
        With entity
            .Id = Id
            .Libelle = Libelle

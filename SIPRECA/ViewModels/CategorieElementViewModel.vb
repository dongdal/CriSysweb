...
Public Class CategorieElementViewModel
    ...
    Public Sub New(entity As CategorieElement)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As CategorieElement
        Dim entity As New CategorieElement
        With entity
            .Id = Id
            .Libelle = Libelle

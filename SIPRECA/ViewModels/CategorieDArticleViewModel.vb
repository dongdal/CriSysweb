...
Public Class CategorieDArticleViewModel
    ...
    Public Sub New(entity As CategorieDArticle)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As CategorieDArticle
        Dim entity As New CategorieDArticle
        With entity
            .Id = Id
            .Libelle = Libelle

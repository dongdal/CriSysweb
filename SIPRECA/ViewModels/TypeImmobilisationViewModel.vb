...
Public Class TypeImmobilisationViewModel
    ...
    Public Sub New(entity As TypeImmobilisation)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As TypeImmobilisation
        Dim entity As New TypeImmobilisation
        With entity
            .Id = Id
            .Libelle = Libelle

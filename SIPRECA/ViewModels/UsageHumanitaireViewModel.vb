...
Public Class UsageHumanitaireViewModel
    ...
    Public Sub New(entity As UsageHumanitaire)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As UsageHumanitaire
        Dim entity As New UsageHumanitaire
        With entity
            .Id = Id
            .Libelle = Libelle

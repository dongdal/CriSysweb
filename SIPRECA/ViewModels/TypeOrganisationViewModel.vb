...
Public Class TypeOrganisationViewModel
    ...
    Public Sub New(entity As TypeOrganisation)
        With Me
            .Id = entity.Id
    ...
    Public Function GetEntity() As TypeOrganisation
        Dim entity As New TypeOrganisation
        With entity
            .Id = Id
            .Libelle = Libelle
